...
For the Game of Life simulation, the State is a matrix containing boolean values. The Rule describes what the value of each entry of a State turns to, given the values of the 8 entries surrounding it. 
