...
\cite{Wilson J. 2018} chapter two goes into depth about Strong and Weak emergence contrast in terms of causal powers in response to a canonical argument against causal emergence, referred to as the overdetermination argument (originally presented by Jaegwon Kim):

\begin{enumerate}
    \item[A1.] Emergent properties are dependent upon lower-level properties (base properties).
    ...
    \item[A6.] Effects are not at once caused by two distinct and sufficient causes (overdetermination).
    \item[C.] Emergent properties yield overdetermination.
\end{enumerate}

There are two cases of the problem, the first is this setup (classic overdetermination):
