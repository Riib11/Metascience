...
% TODO general list
%-------------------------------------------------------------------------------
% - go fix todos esp. where you want to put in Searles thing
% - rewrite abstract
...
%-------------------------------------------------------------------------------
\begin{center}
	\huge{\bf Weak Emergence as Procession} % paper title
    \\[0.75cm] 
...
% TODO: not sure how to tie this in:
% For example, \ti{Dennett's lost sock center} --- ``the point defined as the center of the smallest sphere that can be inscribed around all the socks I have ever lost in my life'' --- is PSPC emergent because (TIPC) any power that Dennett's lost sock center manifests is 

% talk about emergence being dynamic, like in \cite{Bedau M. 2018}
