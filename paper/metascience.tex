...
% TODO: next!
% - consider bedau's response to overdetermnation (\cite{Bedau M. 2018})
%   and how it compares and/or coincides with wilson's powers requirements
% - consider how PSPC deals with epistomological concerns in comparison
%   to complexity conditions
% - suggest that a modified mixture of both is an answer to some important
%   open questions about emergence. the mixture has to apply complexity to
%   casual powers, and show how to get rid of 'resultants' which are just
%   like the move-effect where the higher-level parts arent actually
%   causally effective (that conciousness talk). basically the parts taht
%   wilson says that bedau needs to add about causation
% - show how thinking of the property type, emergence, is best thought of as
%   a kind of procession (marchign sense, the carrying out of a process)
%   something like that
