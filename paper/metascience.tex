...
% TODO general list
%------------------------------------------------
% - make sure that periods come before closing double-quotes
...
%------------------------------------------------
\begin{center}
	\huge{\bf The Weak Emergence Procession} % paper title
    \\[0.75cm] 
...
\section{Epistemic and Ontological Considerations}
