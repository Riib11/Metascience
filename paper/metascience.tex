...
\begin{enumerate}
    \item[I.] $S \squigrightarrow S^*$ and $P \squigrightarrow S^*$ (classical overdetermination)
    \item[II.] $S \squigrightarrow P^*$ and $P \squigrightarrow P^*$ (downward cuasation)
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \tb{Strong emergentism}: Not every low-level effect has a low-level cause; deny $P \squigrightarrow P^*$.
