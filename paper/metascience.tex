...
Although the described project would interseting to explore, it is certainly a concession of the original \ti{feel} of ``emergence''. If to be ``emergent'' is just to be crudely (and possibly usefully) explained, then emergence has not metaphysical substance, which was clearly the driving force behind the canonical examples of applying emergence to consciousness, free will, etc. Obviously we do not have a physically-reductive explanation of either, and it is not unlikely that we might never, but is to assume that one does exist an act of epistemic humility or the opposite? And is to appeal to emergence an act of arrogance?

Take, for example, consciousness. If after some time $t$ we have not found a physically-reductive explanation for it and we have not found a proof that one mustn't exist, then it is not implied that one does not exist, of course. And for not $t$ will this be true. But how long do we have to wait to be justified in assuming there is none? Although puzzling on the surface, questions like these tend to dissolve as science around the topic develops. At one time it was wondered how % TODO- not sure if this part is necessary, go onto substance instead

Consciousness has remained a popular mystery thoughout all of recorded history, and even with all recent technological innovations, we seem to have raised more questions than we have answered in regards to it. 

% implications of purely epistomological emergence

% motivations and evidence for ontological emergence e.g. the success of the special sciences
